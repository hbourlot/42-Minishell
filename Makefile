...
C_FUNCTIONS		= parsing/parsing 																							\
					initialize/init_command initialize/init_program	initialize/init_shell									\
					execution/argument_parser execution/execute_cmds execution/execute_cmds_utils execution/get_path		\
